...
fid    = fopen( '../coverage/bestserver-foyer-r2.txt' );
...
fout = fopen('capacity-foyer.txt','r');
...
cellcentres('../cells-foyer-start.txt');
%cellcentres('../cells-foyer-r1.txt');
%cellcentres('../cells-foyer-r2.txt');
endlocations('../../linux/locations-foyer.txt');
%view( -10, 85 );
axis tight;
