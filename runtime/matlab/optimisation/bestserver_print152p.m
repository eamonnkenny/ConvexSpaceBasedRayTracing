...
fid    = fopen( '../coverage/bestserver-print152p-r2.txt' );
...
fout = fopen('capacity-print152p.txt','r');
...
cellcentres('../cells-print152p-start.txt');
endlocations('../../linux/locations-print152p.txt');
%view( -10, 85 );
axis tight;
