...
%plot( y441(:,1),y441(:,2),'r:o', y331(:,1),y331(:,2),'m:o', y330(:,1),y330(:,2),'g:o', y131(:,1),y131(:,2),'c:o', y130(:,1),y130(:,2),'c-o',y331(:,1),m(:,1),'-k.',y331(:,1),v(:,1),'b--*');
plot( y441(:,1),y441(:,2),'r:o', y441(:,1),m(:,1),'-k.',y441(:,1),v(:,1),'b--*');
...
legend('r4-t4-d1','Measurements','VEFIE')
legend('show')
