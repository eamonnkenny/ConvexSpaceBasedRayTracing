...
Eexact = componentsRT( 'liney.res',    M, N, 9  );
...
figure;
plot( y, normedEexact( :, 1 ), 'r-', y, normedEs( :, 1 ), 'g-.' );
title( 'Exact Scattered Field versus UTD Diffracted field, line = (-20,y,20)' );
xlabel( 'y/metres' );
ylabel( 'scattered field' );
